      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="p-4 md:p-6 lg:p-8">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            {/* Key Metrics Grid - Adjusted for better value visibility */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-white to-slate-50/50 dark:from-slate-800 dark:to-slate-700/50 rounded-2xl p-6 border-0 shadow-lg hover:shadow-xl transition-all duration-300 min-h-[120px] flex flex-col">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-foreground">Despesas do Mês</h3>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-red-500 to-red-600 flex items-center justify-center shadow-sm flex-shrink-0">
              ...
              <div className="bg-gradient-to-br from-white to-slate-50/50 dark:from-slate-800 dark:to-slate-700/50 rounded-2xl p-6 border-0 shadow-lg hover:shadow-xl transition-all duration-300 min-h-[120px] flex flex-col">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 flex items-center justify-center shadow-sm flex-shrink-0">
                    <DollarSign className="w-6 h-6 text-white" />
                  </div>
                </div>
                <div className="flex-1 flex items-center">
              ...
              <div className="bg-gradient-to-br from-white to-slate-50/50 dark:from-slate-800 dark:to-slate-700/50 rounded-2xl p-6 border-0 shadow-lg hover:shadow-xl transition-all duration-300 min-h-[120px] flex flex-col">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-red-600 to-red-700 flex items-center justify-center shadow-sm flex-shrink-0">
                    <DollarSign className="w-6 h-6 text-white" />
                  </div>
                </div>
                <div className="flex-1 flex items-center">
