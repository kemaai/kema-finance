  ...
  return (
    <div className="flex gap-2">
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button 
            variant="outline" 
            size="icon"
            className="h-12 w-12 bg-background hover:bg-accent border-border shadow-sm hover:shadow-md transition-all duration-200 relative"
          >
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button 
            className="h-12 px-4 bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm hover:shadow-md transition-all duration-200"
          >
